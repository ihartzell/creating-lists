...
public class Driver 
{
	...
	public static void main(String[] args) 
	{
		...
		{	
			...
			// I'm creating an array list of Facebook user objects and assigning it to my facebook object where I call for
			// my getUsers method which has an array list of everybody.
			// Then I sort this array list using the Collections class and calling for the sort method with the array list as
			// one argument and the FriendsCountComparator as another argument.
			// Then for each Facebook user within the array list that I created here. I print out
			// each user calling for the getUsername method and the getFriends method as well as the size method for the array list.
			// This way it'll show how many friends each user has.
			...
			case 10: serialization(facebookObj);
					System.out.println();
					System.out.println("Logging off...");
				break;
				
			} // end of switch statement or else-if essentially.
		} while(menuChoice >= 1 && menuChoice <= 9 ); // end of the do-while loop and really what runs the program.	
	...
	public static int menu()
	{
		...
		{
			System.out.println("Facebook Menu:");
			System.out.println(menuChoice + " is an invalid option, please choose 1-10.");
			System.out.println("-------------");
			System.out.println("1.List User(s) alphabetically:");
			System.out.println("2.List User(s) by number of friends:");
			System.out.println("3.Add User:");
